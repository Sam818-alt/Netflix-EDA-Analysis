...
📊 A complete data analysis project uncovering patterns, trends & insights from Netflix’s global catalog.
...
3. Popular genres, ratings & countries
4. Duration analysis
5. Text-based insights using WordClouds
6. Actor & director frequency
...
🌟 Future Improvements
    ...
    Build recommendation engine (optional)
